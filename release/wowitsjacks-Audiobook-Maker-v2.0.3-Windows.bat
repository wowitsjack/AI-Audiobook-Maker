@echo off
REM wowitsjack's Audiobook Maker v2.0.3 - Windows Launcher
REM This script sets up the environment and runs the audiobook generator

title wowitsjack's Audiobook Maker v2.0.3 - Windows

echo.
echo    🎧 wowitsjack's Audiobook Maker v2.0.3 - Windows Launcher
echo    ============================================================
echo.
...
echo    🎧 Starting wowitsjack's Audiobook Maker v2.0.3...
echo.
